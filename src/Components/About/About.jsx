  ...
  return (
    <div className='about'>
      <div className="about-left">
        <img src="https://greatstack.in/assets/about-Bupj5-5F.png" alt="" className='about-img'/>
        <img src="https://greatstack.in/assets/play-icon-DiRyRcRm.png" alt="" className='play-icon'/>
      </div>
