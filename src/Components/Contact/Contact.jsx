...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "d85c656d-fcba-4797-8537-45c371d88acf");
    ...
    <div className='contact'>
      ...
      <div className="contact-col">
        <form onSubmit={onSubmit}>
            ...
            <label>Write Your meaasge here</label>
            <textarea name="message" rows='6' placeholder='Enter your message' required></textarea>
            <button type='submit' className='btn dark-btn'>Submit Now <img style={{width: '25px'}} src="data:image/png;base64," alt="" /></button>
        </form>
        <span>{result}</span>
      </div>
    </div>
